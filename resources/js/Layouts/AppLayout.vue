        ...
        <div class="flex justify-between h-16">
          <div class="flex">
            ...
            <div class="flex-shrink-0 flex items-center">
              <a href="/dashboard">
                <jet-application-mark class="w-auto" />
              </a>
            </div>
            ...
            <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                <jet-nav-link href="/achievements" :active="$page.currentRouteName == 'achievements'">
                    Achievements
                </jet-nav-link>
            </div>
            <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                <jet-nav-link href="/rules" :active="$page.currentRouteName == 'rules'">
                    Rules
                </jet-nav-link>
            </div>
            <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                <jet-nav-link href="/cabinet" :active="$page.currentRouteName == 'cabinet'">
                    Cabinet
                </jet-nav-link>
            </div>
          </div>
            ...
            <div class="ml-3 relative">
              <jet-dropdown align="right" width="48">
                ...
                <template #content>
                  ...
                  <jet-dropdown-link href="/vote"> Votes </jet-dropdown-link>

                  <jet-dropdown-link href="/achievements">
                    Achievements
                  </jet-dropdown-link>

                  <jet-dropdown-link href="/rules"> Rules </jet-dropdown-link> -->
